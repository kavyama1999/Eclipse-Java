...
@WebServlet(urlPatterns = "/tv",loadOnStartup = 2)

public class TvReachargeServlet  extends HttpServlet{
	
	
	
	public TvReachargeServlet()
	{
...
String recharge1=	req.getParameter("rechargetype");
String accept=	req.getParameter("accept");

	
	
//System.out.println("Customer Id :" + customerId + "\n Select Vendor :"+vendor+ "\n Reacharge Amount  : " +recharge+"\n Reacharge Type :" +recharge1+"\n Accept :"+accept);
...
// Navbar start
	    ...
	    writer.write("<br>");
	    writer.write("<b><h2>Application is processing</h2></b>");
